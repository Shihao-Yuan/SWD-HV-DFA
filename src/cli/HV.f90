...
!                              Modified API integration: Shihao Yuan (syuan@mines.edu)                              !
!                                                                                                                  !
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      INCLUDE 'dispersion_solver.f90'         ! Root search procedure (translated into FORTRAN and adapted from Geopsy)
      INCLUDE 'root_solver.f90'        ! Aux. procedures of the root solver (translated into FORTRAN and adapted from Geopsy)  
      INCLUDE 'dispersion_equation.f90'       ! Frequency equation, which vanishes on the dispersion curves (new)
              
      ! PROCEDURES FOR SW PART OF THE GREEN'S FUNCTIONS (COMPUTATION OF DISPERSION CURVES EXCLUDED)       
      INCLUDE 'greens_rayleigh.f90'
      INCLUDE 'greens_love.f90'
      INCLUDE 'rayleigh_mode.f90'
      INCLUDE 'love_mode.f90'
      
      ! PROCEDURES FOR BW PART OF THE GREEN'S FUNCTIONS
      INCLUDE 'bodywave_integrals.f90'
      ...
      INCLUDE 'cli_args.f90'        ! STANDARD F03+ in .f90 form. Runs under gfortran, ftn95, and most Fortran 2003+ compilers
