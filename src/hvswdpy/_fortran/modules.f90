      ...
      module TYPES
      implicit none
      integer,parameter::long_float=selected_real_kind(15,300)
      ...
      REAL(long_float) G_OMEGA
      REAL(long_float)::G_PRECISION ! MARC WAS USING 1.E-7
      ...
      REAL(long_float)::G_DX=0.1_long_float! SLOWNESS INCREMENT (DEFAULT 10%)
      ...
      REAL(long_float),ALLOCATABLE::G_SLOWS(:),G_SLOWP(:)
      ...
      REAL(long_float) SOLVER_RELATIVESTEP,SOLVER_SEARCHSTEP
      REAL(long_float) G_MAXRAYLEIGHSLOWNESS,G_SLOWSMIN,G_SLOWSMAX
      INTEGER ILAYER                  
